...
To run the website on your local machine, please navigate to the FrontEnd directory and run "python3 run.py" using your command line.  

Note you may have to install flask ("pip3 install flask")
